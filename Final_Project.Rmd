...
sugar: 0.6900412 
acidity: 0.004675939
cluster_weight: -0.004672546 
berry_size: 0.4783609 
sun: 0.5426107 
soil: 0.04112437 
rain: 0.02780617 
week: -0.03863471
...
```{r}
ggplot(grapes, mapping = aes(x = sun_exposure_hours, y = acidity_ph))+
  geom_point(mapping = aes(colour = variety))+
  facet_wrap(~region)+
  geom_smooth(method = 'lm', formula = 'y~x')
```

```{r}
scatter<-scatterplot3d(x = grapes$berry_size_mm, y = grapes$sugar_content_brix, z = grapes$quality_score)
fit <- lm(grapes$quality_score~grapes$berry_size_mm+grapes$sugar_content_brix)
scatter$plane3d(fit)
```
